...
public class Post {
    ...
    */
    ...
    public List<Reaction> getPosts() {
        return posts;
    }

    public void setPosts(List<Reaction> posts) {
        this.posts = posts;
    }

    public List<PostReactionMap> getReactions() {
        return reactions;
    }

    public void setReactions(List<PostReactionMap> reactions) {
